import { BasePom, ByCssElement, ByDataCyElement, ByXpathElement, NestedElement } from "./page";

export class Dashboard extends BasePom {
    elements = {
        sidebar: {
            container: () => new ByDataCyElement(this.page, "sidebar"),
            panel: (name: "Broker Tools" | "Search Tools" | "Account") => new ByXpathElement(this.page, `//mat-expansion-panel-header[./span[normalize-space(.)="${name}"]]`),
            accountPanel: {
